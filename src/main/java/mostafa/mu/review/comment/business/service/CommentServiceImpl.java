...
import mostafa.mu.review.comment.business.mapper.ICommentMapper;
import mostafa.mu.review.comment.persistence.CommentEntity;
import mostafa.mu.review.comment.persistence.ICommentRepository;
...
public class CommentServiceImpl implements ICommentService {
  ...
  @Override
  public CommentDto addComment(CommentDto commentDto, String username, Long productId)
      throws IOException {
